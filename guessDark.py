...
image_label = tk.Label(master=window,height=800,width=1024)
image_label.pack()
...
def display_random_image():
    ...
    image = tk.PhotoImage(file=dir + filename,height=800)
...
window.bind("<Shift_L>", color_image)
